...
def scan_energy_1_range(start, step, points, file_name, exposure_time):
    hc = 12398.4244
    dspacing = 3.1356
    crystal_1 = epics.PV("BL62:iXI4:m4.VAL")
    a=[]
    b=[]
    c=[]
    d=[]
    ...
    epics.PV("BL62:ANDOR3:cam1:AcquireTime").put(0.1, wait=True)
    ...
    for i in range(0, points):
        ...
        h.append(epics.PV("BL62:iXI4:m4.RBV").get(as_numpy=True))
    f = open(file_name, "a")
...
def scan_energy_2_ranges(start, step, points, start1, step1, points1, file_name, exposure_time):
    ...
    for i in range(0, points1):
        ...
        b.append(epics.PV("BL62:ANDOR3:ROIStat1:1:Total_RBV").get(as_numpy=True)) 
        h.append(epics.PV("BL62:iXI4:m4.RBV").get(as_numpy=True))
    epics.PV("BL62:ANDOR3:cam1:Acquire").put('Done')
    f = open(file_name, "a")
