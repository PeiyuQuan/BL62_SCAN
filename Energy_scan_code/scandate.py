...
layout1 = [
    [sg.Text("1st start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start1-'),
     sg.Text("eV")],
    [sg.Text("1st step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step1-'),
     sg.Text("eV")],
    [sg.Text("1st points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points1-'),
     sg.Text("points")],
...
layout2 = [
    [sg.Text("1st start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start21-'),
     sg.Text("eV")],
    [sg.Text("1st step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step21-'), sg.Text("eV")],
    [sg.Text("1st points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points21-'),
     sg.Text("points")],
    [sg.Text("2nd start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start22-'),
     sg.Text("eV")],
    [sg.Text("2nd step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step22-'), sg.Text("eV")],
    [sg.Text("2nd points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points22-'),
     sg.Text("points")],
...
layout3 = [
    [sg.Text("1st start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start31-'),
     sg.Text("eV")],
    [sg.Text("1st step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step31-'), sg.Text("eV")],
    [sg.Text("1st points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points31-'),
     sg.Text("points")],
    [sg.Text("2nd start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start32-'),
     sg.Text("eV")],
    [sg.Text("2nd step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step32-'), sg.Text("eV")],
    [sg.Text("2nd points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points32-'),
     sg.Text("points")],
    [sg.Text("3rd start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start33-'),
     sg.Text("eV")],
    [sg.Text("3rd step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step33-'), sg.Text("eV")],
    [sg.Text("3rd points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points33-'),
     sg.Text("points")],
...
layout4 = [
    [sg.Text("1st start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start41-'),
     sg.Text("eV")],
    [sg.Text("1st step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step41-'), sg.Text("eV")],
    [sg.Text("1st points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points41-'),
     sg.Text("points")],
    [sg.Text("2nd start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start42-'),
     sg.Text("eV")],
    [sg.Text("2nd step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step42-'), sg.Text("eV")],
    [sg.Text("2nd points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points42-'),
     sg.Text("points")],
    [sg.Text("3rd start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start43-'),
     sg.Text("eV")],
    [sg.Text("3rd step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step43-'), sg.Text("eV")],
    [sg.Text("3rd points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points43-'),
     sg.Text("points")],
    [sg.Text("4th start energy", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-start44-'),
     sg.Text("eV")],
    [sg.Text("4th step", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-step44-'),
     sg.Text("eV")],
    [sg.Text("4th points", size=(13, 1), justification='center'), sg.Input(size=(15, 200), key='-points44-'),
     sg.Text("points")],
